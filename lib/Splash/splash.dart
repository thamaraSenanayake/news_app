...
contentEnglish +="[PICTURE]Each individual coral is referred to as a polyp. Coral polyps live on the calcium carbonate exoskeletons of their ancestors, adding their own exoskeleton to the existing coral structure. As the centuries pass, the coral reef gradually grows, one tiny exoskeleton at a time, until they become massive features of the marine environment.";
contentEnglish +="[PICTURE]Corals are found all over the world's oceans, from the Aleutian Islands off the coast of Alaska to the warm tropical waters of the Caribbean Sea. The biggest coral reefs are found in the clear, shallow waters of the tropics and subtropics. The largest of these coral reef systems, the Great Barrier Reef in Australia, is more than 1,500 miles long (2,400 kilometers).";
